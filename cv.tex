...
\cvline{}{Working for NICE, has also given me a lot of knowledge on \textbf{Virtualization}, \textbf{HPC}, \textbf{Network protocol development}, \textbf{Openssl}, \textbf{Opengl}, insights on the \textbf{USB spec}, \textbf{Kernel module programming}.}
...
\cventryline{As part of the development I used and improved my skills on \textbf{Virtualization}, \textbf{HPC}, \textbf{C++}, \textbf{C}, \textbf{Python}, \textbf{XML}, \textbf{Visual Studio}, \textbf{Autotools}, \textbf{Jenkins}, \textbf{Git}, \textbf{Subversion}, \textbf{Network protocol development}, \textbf{Openssl}, \textbf{Shell scripting}, \textbf{Powershell}, \textbf{Opengl}.}
...
\section{Education}
\cventry{2009--2012}{Computer engineer}{University of Vigo}{Ourense}{}{Extended knowledge in computer networks, security protocols, databases, formal methods for software engineering and various programming paradigms.}
\cventryline{As part of the education I also made an Erasmus in Poland (Akademia Techniczno-Humanistyczna, Bielsko-Biała) from 2010 to 2011.}
\cventry{2004--2008}{Technical engineer in computer management}{University of Vigo}{Ourense}{}{Knowledge in programming, algebra, calculus, interface design,
validation and testing, database, computer networks, operating systems, data structures and software engineering.}
...
\cvline{}{GTK+, Glib, Pango, libxml2, Cairo, Openssl, Opengl}
\cvline{}{Clutter, MX and GStreamer}

\subsection{Version control systems}
\cvline{}{Git, Subversion, CVS and Bazaar}

\subsection{Continuous integration}
\cvline{}{Jenkins}

\section{Personal attributes}
\cvline{}{I consider myself to be a hardworking, punctual, sociable individual, desirous for learning new things.}
...
\cvlistdoubleitem{\href{mailto:jose.manuel.pintor.freire@cern.ch}{jose.manuel.pintor.freire@cern.ch}}{\href{mailto:paolo.borelli@gmail.com}{paolo.borelli@gmail.com}}
