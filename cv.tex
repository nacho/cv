...
\cventryline{\textbf{gedit} is the official text editor of the GNOME desktop environment. It is written in \textbf{C} and \textbf{Python}.}
\cventryline{\textbf{gtksourceview} is a source code editing widget written in \textbf{C}.}
\cventryline{\textbf{gitg} is a git repository viewer written in \textbf{Vala}}
\cventryline{\textbf{libgit2-glib} is a \textbf{C} library that \textbf{binds} libgit2 using GObject.}
\cventryline{\textbf{Gtranslator} is an enhanced gettext PO file editor written in \textbf{C} and \textbf{Python}.}
